...
const Feature = ({
  ...
  if (layout === "special") {
    ...
    const imageContent = (
      <div className="md:w-1/2">
        <OptimizedPicture src={imageSrc} alt={title} className="mx-auto max-h-96 md:max-h-[450px] object-contain" />
      </div>
    );
  ...
  return (
    <motion.div
      ...
      <OptimizedPicture src={imageSrc} alt={title} className="mx-auto mt-4 max-h-96 md:max-h-[450px] object-contain" />
    </motion.div>
  );
};
...
export default function Home() {
  return (
    <>
      <Header />
      <main className="relative text-white max-w-[100vw] overflow-clip">
        {/* Background Images */}
        <ResponsiveBackgroundImage
          mobileSrc="/greek_background_photos/1.png"
          desktopSrc="/greek_background_photos/1.png"
          className="w-full md:w-3/5 h-auto top-10 md:top-0  object-contain"
        />
        <ResponsiveBackgroundImage
          mobileSrc="/greek_background_photos/2.png"
          desktopSrc="/greek_background_photos/2.png"
          className="w-full md:w-2/3 lg:w-1/2 h-auto left-1/2 transform -translate-x-1/2 top-[230vh] md:top-[180vh] object-contain"
        />
        <ResponsiveBackgroundImage
          mobileSrc="/greek_background_photos/3.png"
          desktopSrc="/greek_background_photos/3.png"
          className="w-2/3 md:w-1/2 lg:w-1/3 h-auto bottom-[0] left-0 object-contain"
        />
        <ResponsiveBackgroundImage
          mobileSrc="/greek_background_photos/4.png"
          desktopSrc="/greek_background_photos/4.png"
          className="block w-2/3 md:w-1/2 lg:w-1/3 h-auto top-[400vh] md:top-[320vh] right-0 object-contain"
        />
